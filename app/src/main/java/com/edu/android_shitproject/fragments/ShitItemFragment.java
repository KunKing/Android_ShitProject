...
public class ShitItemFragment extends Fragment implements Callback<ShitItem> {
    ...
    @Override
    public void onResponse(Response<ShitItem> response, Retrofit retrofit) {
